...
(function () {
    ...
    const THEMES = {
        ...
        bloody: {
            name: 'Bloody',
            css: '--theme-bg:#130406;--theme-panel:#2b0a0f;--theme-accent:#b56576;--theme-text:#e8d7dc;--theme-canvas-filter:saturate(0.88) contrast(0.98) brightness(0.9);'
        },
        neon: {
            name: 'Neon',
            css: '--theme-bg:#040414;--theme-panel:#0a1230;--theme-accent:#4ea8de;--theme-text:#dce8f0;--theme-canvas-filter:saturate(0.92) brightness(0.94);'
        }
    };
    ...
    const installStyle = () => {
        ...
        style.textContent = `
            ...
            #settings-theme-select { background: var(--theme-panel); color: var(--theme-text); border:1px solid rgba(255,255,255,.25); border-radius:4px; }
        `;
